...
sys.path.append('.')
sys.path.append('..')
from VAE_utils.normalize import *
from VAE_utils.cv.resnet_v2 import ResNet18
from VAE_utils.log_info import *
...
class FL_CVAE_cifar(AbstractAutoEncoder):
    def __init__(self, args, d, z, device, with_classifier=True, **kwargs):
        ...
        self.encoder_former = nn.Conv2d(1, d // 2, kernel_size=4, stride=2, padding=1, bias=False) if args.dataset == 'femnist' else \
        ...
        self.decoder_last = nn.ConvTranspose2d(d // 2, 1, kernel_size=4, stride=2, padding=1, bias=False) if args.dataset == 'femnist' else \
        ...
        self.f = 8 ##FEMINST是7，但是CIFAR10是8
        self.d = d
        self.z = z
