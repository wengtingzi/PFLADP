...
from VAE_utils.util2s import Cutout
...
class Dataset_3Types_ImageData(data.Dataset):
    ...
    def __getitem__(self, index):
        img1 = self.ori_data[index]
        img2 = self.share_data1[index % len(self.share_data1)]
        img3 = self.share_data2[index % len(self.share_data2)]
    
        targets1 = self.ori_targets[index]
        targets2 = self.share_targets1[index % len(self.share_targets1)]
        targets3 = self.share_targets2[index % len(self.share_targets2)]
